module.exports = {
    ...
    theme: {
        ...
        colors: {
            ...
            'opacity-white-15': 'rgba(255, 255, 255, .15)',
            'opacity-white': 'rgba(255, 255, 255, .2)',
            'opacity-hiver-yellow': 'rgba(255, 193, 40, .2)',
        ...
        boxShadow: {
            ...
            // project
            soft: '2px 2px 11px 0px rgba(0,0,0,0.03)',
            base: '0px 3px 6px rgba(231,231,231, .8)',
    ...
    variants: {
        ...
        borderWidth: ['responsive', 'focus', 'hover', 'last', 'first'],
